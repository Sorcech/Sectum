<template>
  <div class="flex flex-col p-2">
    ...
    <ipt :label="t('data.Point')" v-model="item.Point"></ipt>
    <ipt :label="t('data.Detail')" v-model="item.Detail"></ipt>
    <ipt :label="t('data.Desity')" v-model="item.Desity"></ipt>
    <ipt :label="t('data.Yield')" v-model="item.Yield"></ipt>
    <ipt :label="t('data.Ultima')" v-model="item.Ultima"></ipt>
    <ipt :label="t('data.Elastic')" v-model="item.Elastic"></ipt>
...
import type { StandardDetail } from '~/type'
